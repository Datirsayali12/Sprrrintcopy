# Generated by Django 5.0.2 on 2024-03-29 09:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateField(auto_now=True)),
                ('created_at', models.DateField(auto_now_add=True)),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='UIAsset.asset')),
        ...
        migrations.AddField(
            model_name='asset',
            name='image',
            field=models.ManyToManyField(to='UIAsset.image'),
        ),
        migrations.CreateModel(
            name='Pack',
            fields=[
